...
export default function TablesPage() {
  ...
  const fetchTables = async () => {
    try {
      const response = await axios.get('http://ec2-3-111-41-233.ap-south-1.compute.amazonaws.com:8080/api/table/restaurant/my-table', {
        headers: {
  ...
  const handleAddTable = async (e: React.FormEvent) => {
    ...
    try {
      setLoading(true);
      const response = await axios.post('http://ec2-3-111-41-233.ap-south-1.compute.amazonaws.com:8080/api/table/add-table', 
  ...
  const confirmDelete = async () => {
    try {
      ...
      const response = await axios.delete(
        `http://ec2-3-111-41-233.ap-south-1.compute.amazonaws.com:8080/api/table/restaurant/remove-table/${deleteModal.tableId}`,
        {
          headers: {
            'Authorization': `Bearer ${localStorage.getItem('token')}`
          }
