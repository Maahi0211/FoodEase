  ...
  const fetchTablesAndOrders = async () => {
    try {
      ...
      const tablesResponse = await axios.get(
        'http://ec2-3-111-41-233.ap-south-1.compute.amazonaws.com:8080/api/table/restaurant/my-table',
        {
          headers: {
      ...
      const ordersResponse = await axios.get(
        'http://ec2-3-111-41-233.ap-south-1.compute.amazonaws.com:8080/api/order/get-order-by-token',
        {
          headers: {
            'Authorization': `Bearer ${localStorage.getItem('token')}`
          }
  ...
  const updateOrderStatus = async (orderId: string, status: string) => {
    try {
      ...
      const response = await axios.put(
        `http://ec2-3-111-41-233.ap-south-1.compute.amazonaws.com:8080/api/order/update-order-status/${orderId}`,
        { status },
        {
          headers: {
            'Authorization': `Bearer ${localStorage.getItem('token')}`
